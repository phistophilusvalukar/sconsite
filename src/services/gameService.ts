...
class GameService {
  ...
  private transformCharacterFromDb(dbCharacter: Record<string, unknown>): Character {
    return {
      ...
      profileSubtitleFontFamily: (dbCharacter.profile_subtitle_font_family || dbCharacter.profile_font_family || 'cinzel') as Character['profileSubtitleFontFamily'],
      profileFontFamily: (dbCharacter.profile_font_family || 'cinzel') as Character['profileFontFamily'],
      profileAccentFontFamily: (dbCharacter.profile_accent_font_family || dbCharacter.profile_font_family || 'cinzel') as Character['profileAccentFontFamily'],
      profileTitleFontSize: Number(dbCharacter.profile_title_font_size || 124),
      ...
      profileBackgroundColorSource: (dbCharacter.profile_background_color_source || 'base') as Character['profileBackgroundColorSource'],
