...
type CharacterCreateInput = Omit<
  ...
  | 'profileSplashHidePortraitBackground'
  | 'profileAtmosphereImageUrl'
  | 'profileAtmospherePositionX'
  | 'profileAtmospherePositionY'
  | 'profileAtmosphereSize'
  | 'profileAtmosphereOpacity'
  | 'profileAtmosphereParallax'
  | 'profileForegroundImageUrl'
  | 'profileForegroundAnchor'
  | 'profileForegroundPositionX'
  | 'profileForegroundPositionY'
  | 'profileForegroundSize'
  | 'profileForegroundOpacity'
  | 'profileForegroundParallax'
