...
const member = (characterId: string, dynamicPortraitEnabled: boolean, cutoutUrl?: string, status: 'active' | 'retired' | 'dead' = 'active') => ({
...
describe('guild Class Photo arrangement', () => {
  it('only admits guild characters with enabled cutout portraits', () => {
    ...
    expect(isEligibleForGuildLineup(member('44444444-4444-4444-8444-444444444444', true, 'https://example.com/top.webp', 'retired'))).toBe(false);
  });
