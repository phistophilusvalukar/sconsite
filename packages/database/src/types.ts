...
export interface MatchCommandRow { id:string; match_id:string; player_id:string; player_sequence:number; expected_revision:number; command:Json; status:"pending"|"processing"|"accepted"|"rejected"; rejection_code:string|null; created_at:string }
export interface MatchSnapshotRow { match_id:string; revision:number; player_id:string; snapshot:Json; created_at:string }
export interface GameDatabase {
  public: { Tables: {
    ...
    match_commands:{Row:MatchCommandRow;Insert:never;Update:never};
    match_snapshots:{Row:MatchSnapshotRow;Insert:never;Update:never};
  }};
}
