/* REBOOT removes every player-owned Ancient Terminal artifact before restoring a pristine row. */
...
REVOKE ALL ON FUNCTION public.reset_ancient_terminal_progress_command() FROM PUBLIC, anon;
