/*
  ...
  Adds a fourth palette color for translucent text and record panels. Existing
  profile commands are wrapped so the full save remains atomic and owner-only.
*/
