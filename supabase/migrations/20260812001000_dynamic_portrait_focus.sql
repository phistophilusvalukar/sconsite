/*
  # Dynamic Portrait crop focus

  Follow-up migration for databases that already applied the initial Dynamic
  Portrait migration before eye-focus coordinates were added locally.
*/
